...
\begin{quotation}
  \textbf{我在2024.09.21 16:18再次运行elegantbook-cn.tex文件。Latex-workshop - Intellisense - Citation - Backend选项设置的仍然是bibtex。
  在这种情况下，我用Xelatex - biber - Xelatex x2来编译elegantbook-cn.tex，编译通过，没有错误，虽然有关于中文字体的警告。}
\end{quotation}
